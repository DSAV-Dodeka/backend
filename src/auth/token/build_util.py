...
def decode_refresh(
    rt: SavedRefreshToken, id_info_model: Type[IdInfo]
) -> tuple[AccessTokenBase, IdTokenBase, IdInfo]:
...
def add_info_to_id(id_token: IdTokenBase, id_info: IdInfo) -> dict[str, Any]:
