...
async def get_auth_request(ctx: Context, store: Store, flow_id: str) -> AuthRequest:
...
async def store_auth_request(ctx: Context, store: Store, auth_request: AuthRequest):
