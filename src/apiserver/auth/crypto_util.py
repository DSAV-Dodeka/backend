...
from apiserver.utilities import enc_dict, enc_b64url, dec_b64url, dec_dict


def encrypt_dict(aesgcm: AESGCM, dct: dict) -> str:
...
def decrypt_dict(aesgcm: AESGCM, b64url_crypt_dict: str) -> dict:
